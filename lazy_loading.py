...
class DataSetViews(h5py._hl.dataset.Dataset):
  ...
  def __init__( self, dataset):
    ...
    self.lazy_slice = lazy_slice(self)
...
class lazy_slice(object):
    ...
    def __getitem__(self, new_slice):
      ...
      return lazy_slice(self.dview,self.key_reinit,self.axis_order)
    ...
    def lazy_transpose(self, axis_order = None):
      ...
      return lazy_slice(self.dview,self.key_reinit,axis_order_reinit)
